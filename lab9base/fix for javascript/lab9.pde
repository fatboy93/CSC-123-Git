...
class PSys
{
   ...
   PSys(int num, PVector init_loc, float dl, int letter)
   {
      particles = new ArrayList();
      source = init_loc.get();  // you have to do this to set a vector equal to another vector
      shade = color(random(255), random(255), random(255));  // TODO_2 use this!
...
void setup() 
{
   ...
   for(int i=0; i<num_fire_work; i++)
      fireW1[i] = new PSys(100, new PVector(random(20,width-20), random(40,height/2)),
                            random(60,120), random(30,50),(float) random(0,4));
...
void mousePressed()
{
    ...
    fireW2[0] = new PSys(25, new PVector(80,100), //H
                      0, 1);
    fireW2[1] = new PSys(45, new PVector(150,90), //A
                      5, 2); 
    fireW2[2] = new PSys(25, new PVector(230,100),  //P
                      10, 3); 
    fireW2[3] = new PSys(25, new PVector(300,100),  //P
                      15, 3);
    fireW2[4] = new PSys(30, new PVector(370,100),  //Y
                      20, 4);
    fireW2[5] = new PSys(25, new PVector(120,250),  //N
                      25, 5);
    fireW2[6] = new PSys(25, new PVector(200,250),  //E
                      30, 6);
    fireW2[7] = new PSys(25, new PVector(270,250),  //W
                      35, 7);
    fireW2[8] = new PSys(30, new PVector(160,400),  //Y
                      40, 4);
    fireW2[9] = new PSys(25, new PVector(240,400),  //E
                      45, 6);
    fireW2[10] = new PSys(50, new PVector(320,390),  //A
                      50, 2);
    fireW2[11] = new PSys(25, new PVector(400,400),  //R
                      55, 8);
